      ...
      <div class="flex">
        <form class="form" @submit.prevent="submit()">
          ...
          <div class="input" id="name-container">
            ...
            <label
              for="name"
              v-bind:class="[form.name.length >= 1 ? 'filled' : '']"
            >
              {{ $t("contact.name") }}*
            </label>
          </div>
          <div class="input" id="email-container">
            ...
            <label
              for="email"
              v-bind:class="[form.email.length >= 1 ? 'filled' : '']"
            >
              {{ $t("contact.email") }}*
            </label>
          </div>
          <div class="textarea">
            ...
            <label
              for="text"
              v-bind:class="[form.text.length >= 1 ? 'filled' : '']"
            >
              {{ $t("contact.message") }}
            </label>
          </div>
          ...
          <div class="validation">
            ...
            <div class="numbers">
              ...
              <div class="success hide">
                <lottie-player
                  v-if="form.robot"
                  src="https://assets5.lottiefiles.com/packages/lf20_awyrfcmg.json"
...
export default {
  ...
  methods: {
    clickedNumber(index) {
      ...
      if (sortedNumbers[0] === this.numbers[index]) {
        ...
        if (this.numbers.length < 1) {
          ...
          setTimeout((this.form.robot = true), 1000);
        }
      } else {
        this.numbers = [];
    ...
    submit() {
      ...
      let span = document.querySelector(".errors span");
      let name = document.querySelector("#name-container");
      ...
      if (this.form.name == "") {
        this.form.errors++;
        span.innerHTML = this.$t("contact.errors.name");
        name.classList.add("error");
      }
      if (this.form.email == "") {
        this.form.errors++;
        span.innerHTML = this.$t("contact.errors.email");
        email.classList.add("error");
      }
      if (!this.form.terms) {
        this.form.errors++;
        span.innerHTML = this.$t("contact.errors.terms");
      }
      if (!this.form.robot) {
        this.form.errors++;
        span.innerHTML = this.$t("contact.errors.verify");
      }
      if (this.form.errors != 0) {
        if (this.form.errors > 1) {
          span.innerHTML = this.$t("contact.errors.multiple");
        }
        ...
        .validation {
          ...
          .numbers {
            ...
            .wrong {
              ...
              height: 2.8em;
              cursor: pointer;
              animation: wrong 0.4s ease forwards;
              top: 0.5em;
              svg {
                width: 100%;
                height: auto;
        ...
        .submit {
          ...
          .errors {
            ...
            span {
              ...
              opacity: 1;
              transition-duration: 0.4s;
              text-shadow: 0px 0px 4px rgba($color: #000000, $alpha: 0.5);
            }
          }
