<template>
  <div class="site" id="site">
    ...
    <section id="about">
      <div>
        ...
        <div class="cards">
          <div
            class="card"
            v-for="item in $t('site.about.cards')"
            :key="item.id"
          >
      ...
      <div>
        ...
        <div class="projects-container">
          <div class="project">
            ...
            >
              <path
                d="M1 0V23L14.5 36.5H33.5"
                stroke-linejoin="round"
                stroke="white"
                stroke-width="2"
              />
              <path
                d="M1 31M33.5 37L27.5 31M33.5 37L27.5 43"
                stroke-linejoin="round"
                stroke="white"
                stroke-width="2"
              />
    ...
    <section id="contact">
      ...
      <div
        class="button"
        v-on:mouseover="mouseoverContact"
        v-on:mouseleave="mouseleaveContact"
        @click="clickContact"
      >
        <div class="text">
